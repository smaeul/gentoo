...
src_prepare() {
	...
	PATCHES=(
		...
		"${FILESDIR}"/${PV}/0008-Ignore-broken-and-non-applicable-tests.patch
		"${FILESDIR}"/${PV}/0009-Link-stage-2-tools-dynamically-to-libstd.patch
		"${FILESDIR}"/${PV}/0010-Move-debugger-scripts-to-usr-share-rust.patch
	)
